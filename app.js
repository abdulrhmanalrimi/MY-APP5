...
const LESSONS = {
  ...
  'noun-types': {
    ...
    images: [
      'lessons/القسم%20الثاني%20أقسام%20الاسم/أقسام%20الاسم%20(1).jpg',
      'lessons/القسم%20الثاني%20أقسام%20الاسم/أقسام%20الاسم%20(2).jpg'
    ],
    contentHtml: `
      <p>ينقسم الاسم في العربية بحسب جنسه وعدده، مما يساعدنا على ضبط المطابقة في الجملة.</p>

      <h4>أولًا: من حيث التذكير والتأنيث</h4>
      <ul>
        <li>
          <strong>الاسم المذكر:</strong>
          هو كل اسم دلَّ على ذكر مثل: <em>مُحَمَّد، رَجُل، حِصَان، قِطّ، بَاب، مَسْجِد، جَبَل</em>.
        </li>
        <li>
          <strong>الاسم المؤنث:</strong>
          هو كل اسم دلَّ على أنثى مثل: <em>عَائِشَة، امْرَأَة، بَقَرَة، قِطَّة، نَافِذَة، مَدْرَسَة، شَمْس</em>.
        </li>
      </ul>

      <h4>ثانيًا: من حيث العدد</h4>
      <ul>
        <li>
          <strong>المُفْرَد:</strong>
          ما دل على واحد أو واحدة مثل: <em>بَاب، نَافِذَة، رَجُل، بِنْت</em>.
        </li>
        <li>
          <strong>المُثَنَّى:</strong>
          ما دل على اثنين أو اثنتين بزيادة الألف والنون أو الياء والنون في آخر المفرد مثل:
          <em>بَابَانِ/بَابَيْنِ، نَافِذَتَانِ/نَافِذَتَيْنِ، رَجُلَانِ/رَجُلَيْنِ، بِنْتَانِ/بِنْتَيْنِ</em>.
        </li>
        <li>
          <strong>الجمع:</strong>
          ما دل على أكثر من اثنين، وينقسم إلى:
          <ul>
            <li>
              <strong>جمع تكسير:</strong>
              يتغيّر فيه بناء المفرد مثل: <em>أَفْلَام، كُتُب، مَفَاتِيح</em>.
            </li>
            <li>
              <strong>جمع مذكر سالم:</strong>
              يُزاد فيه واو ونون أو ياء ونون مثل: <em>مُؤْمِنُون/مُؤْمِنِينَ، مُعَلِّمُون/مُعَلِّمِينَ</em>.
            </li>
            <li>
              <strong>جمع مؤنث سالم:</strong>
              تُزاد فيه ألف وتاء في آخر الكلمة مثل: <em>مُؤْمِنَات، مُعَلِّمَات</em>.
            </li>
          </ul>
        </li>
      </ul>
    ...
    quiz: [
      {
        id: 'noun-types-q1',
        question: 'أيٌّ مما يأتي يَعُدّ اسمًا مذكرًا؟',
        options: ['قِطَّة', 'مُحَمَّد', 'مَدْرَسَة', 'شَمْس'],
        correctIndex: 1,
        explanation: 'الاسم المذكر يدل على ذكر، مثل: مُحَمَّد، رَجُل، حِصَان.'
      },
      {
        id: 'noun-types-q2',
        question: 'الجملة التي تحتوي اسمًا مؤنثًا هي:',
        options: [
          'قَرَأَ مُؤْمِنُونَ الكِتَابَ',
          'وَقَفَ رَجُلَانِ عِنْدَ البَابِ',
          'سَافَرَتْ امْرَأَةٌ صَالِحَةٌ',
          'جَاءَ مُعَلِّمُونَ جُدُدٌ'
        ],
        correctIndex: 2,
        explanation: '"امرأة" اسم مؤنث، بينما باقي الكلمات إما مذكرة أو جمع مذكر.'
      },
      {
        id: 'noun-types-q3',
        question: 'ما علامة المثنى في كلمة "نَافِذَتَيْنِ"؟',
        options: ['زيادة الألف والتاء', 'زيادة الألف والنون', 'زيادة الياء والنون', 'تغيير صورة المفرد'],
        correctIndex: 2,
        explanation: 'المثنى يُصاغ بزيادة ألف ونون في الرفع أو ياء ونون في النصب والجر مثل نَافِذَتَيْنِ.'
      },
      {
        id: 'noun-types-q4',
        question: 'أيُّ الكلمات التالية تُعد جمع تكسير؟',
        options: ['مُؤْمِنَات', 'كُتُب', 'مُعَلِّمُون', 'مُؤْمِنِينَ'],
        correctIndex: 1,
        explanation: 'جمع التكسير يغيّر صورة المفرد، وكلمة "كُتُب" جمع تكسير لمفرد "كتاب".'
      },
      {
        id: 'noun-types-q5',
        question: 'صيغة الجمع المذكر السالم تظهر في:',
        options: ['مُعَلِّمُونَ', 'مُؤْمِنَات', 'مَفَاتِيح', 'نَافِذَتَانِ'],
        correctIndex: 0,
        explanation: 'الجمع المذكر السالم يُزاد له واو ونون أو ياء ونون، مثل مُعَلِّمُونَ/مُعَلِّمِينَ.'
      }
    ]
  },
  ...
  interrogatives: {
    ...
    images: [
      'lessons/أسلوب%20الاستفهام/أدوا%20ت%20الاستفهام.jpg'
    ],
    contentHtml: `
      <p>
        أسلوب الاستفهام يُستخدم لطلب الفهم أو الاستعلام عن عاقل أو غير عاقل، زمان أو مكان أو عدد أو حال.
      </p>
      <p>أدوات الاستفهام الرئيسة هي: من، من ذا، ما، ماذا، متى، أيان، أين، كيف، كم، أيّ.</p>
      <ul>
        <li><strong>من / من ذا</strong>: للسؤال عن العاقل مثل: <em>من آخر الخلفاء الراشدين؟</em></li>
        <li><strong>ما / ماذا</strong>: للسؤال عن غير العاقل مثل: <em>ما أحب العلوم إليك؟</em></li>
        <li><strong>متى</strong>: للسؤال عن الزمان الحاضر أو الماضي مثل: <em>متى رجعت؟</em></li>
        <li><strong>أيان</strong>: للسؤال عن الزمان المستقبل مثل: <em>أيان تسافر؟</em></li>
        <li><strong>كيف</strong>: للسؤال عن الحال أو الهيئة مثل: <em>كيف حالك؟</em></li>
        <li><strong>كم</strong>: للسؤال عن العدد أو الكمية مثل: <em>كم كتابًا قرأت؟</em></li>
        <li><strong>أين</strong>: للسؤال عن المكان مثل: <em>أين أخوك؟</em></li>
        <li><strong>أيّ</strong>: لتعيين الشيء مثل: <em>أيُّ رجلٍ أتى؟</em></li>
      </ul>
      <p><em>https://youtu.be/fY-y8LqX6Bk?si=LU1wqp5iTMB_YQOB</em></p>
    `,
    quiz: [
      {
        id: 'int-q1',
        question: 'أيُّ أداةٍ تُستخدم للسؤال عن العاقل؟',
        options: ['أين', 'من', 'ما', 'كم'],
        correctIndex: 1,
        explanation: 'الأداة "من" تأتي للاستفهام عن العاقل.'
      },
      {
        id: 'int-q2',
        question: 'في السؤال "أيان تسافر؟" ما الذي يُستفهم عنه؟',
        options: ['العدد', 'المكان', 'الزمان المستقبل', 'الحال'],
        correctIndex: 2,
        explanation: 'أداة الاستفهام "أيان" مخصَّصة للسؤال عن الزمان المستقبل.'
      },
      {
        id: 'int-q3',
        question: 'أيُّ أداةٍ مناسبة للسؤال عن الحال أو الهيئة؟',
        options: ['كيف', 'متى', 'ما', 'من ذا'],
        correctIndex: 0,
        explanation: '"كيف" تُستعمل للسؤال عن هيئة الشيء أو حاله.'
      },
      {
        id: 'int-q4',
        question: 'جملة "كم كتابًا قرأت؟" تسأل عن:',
        options: ['الزمان', 'المكان', 'العدد', 'الفاعل'],
        correctIndex: 2,
        explanation: 'الأداة "كم" تفيد الاستفهام عن العدد أو الكمية.'
      },
      {
        id: 'int-q5',
        question: 'ما الأداة المناسبة للسؤال عن المكان؟',
        options: ['أين', 'أيان', 'من', 'كيف'],
        correctIndex: 0,
        explanation: 'أداة الاستفهام "أين" تُستخدم للسؤال عن المكان.'
      }
    ]
  },
  ...
  'huruf-jar': {
    ...
    contentHtml: `
      <p>
        يجر الاسم إذا سبقه حرف من حروف الجر أو كان مضافًا إليه، وعلامة الجر الأصلية الكسرة.
      </p>
      <p>من أشهر حروف الجر: حتى، منذ، مذ، الكاف، التاء، اللام، الباء، ربَّ، في، على، عن، إلى، من.</p>
      <table>
        <thead>
          <tr><th>الحرف</th><th>معناه</th><th>مثال مع المجرور</th></tr>
        </thead>
        <tbody>
          <tr><td>من</td><td>الابتداء</td><td>خرج محمدٌ منَ الدارِ</td></tr>
          <tr><td>إلى</td><td>الانتهاء</td><td>وصل المسافرُ إلى بلدِه</td></tr>
          <tr><td>عن</td><td>المجاوزة</td><td>نزل الفارسُ عن الحصانِ</td></tr>
          <tr><td>على</td><td>الاستعلاء</td><td>الكتابُ على المكتبِ</td></tr>
          <tr><td>في</td><td>الظرفية</td><td>تجتمع الأسرةُ في المساءِ</td></tr>
          <tr><td>رُبَّ</td><td>التقليل</td><td>رُبَّ صديقٍ خيرٌ من شقيقٍ</td></tr>
          <tr><td>الباء</td><td>السببية</td><td>أهلكهم الله بذنوبِهم</td></tr>
          <tr><td>الكاف</td><td>التشبيه</td><td>العلمُ كالنورِ</td></tr>
          <tr><td>اللام</td><td>الاختصاص</td><td>الكبرياءُ للهِ</td></tr>
          <tr><td>التاء</td><td>القَسَم</td><td>تاللهِ لا يذهبُ الخيرُ</td></tr>
          <tr><td>مذ / منذ</td><td>الابتداء الزمني</td><td>ما كلمتُه منذُ سنةٍ</td></tr>
          <tr><td>حتى</td><td>الانتهاء</td><td>سهرنا حتى مطلعِ الفجرِ</td></tr>
        </tbody>
      </table>
      <p><em>https://youtu.be/yJ60Yy-_FDg?si=lHCN7SUE-r5eLx9Z</em></p>
    `,
    quiz: [
      {
        id: 'jar-q1',
        question: 'متى يُجرُّ الاسم في العربية؟',
        options: [
          'عند اتصاله بنون التوكيد',
          'إذا سبقه حرف جر أو كان مضافًا إليه',
          'إذا وقع مبتدأً',
          'إذا كان فعلًا'
        ],
        correctIndex: 1,
        explanation: 'الجر يكون بدخول حرف الجر على الاسم أو بكونه مضافًا إليه.'
      },
      {
        id: 'jar-q2',
        question: 'أيُّ حرفٍ يفيدُ معنى الاستعلاء في الأمثلة؟',
        options: ['على', 'عن', 'من', 'إلى'],
        correctIndex: 0,
        explanation: 'الحرف "على" يدل على الاستعلاء مثل: الكتابُ على المكتبِ.'
      },
      {
        id: 'jar-q3',
        question: 'في الجملة "العلمُ كالنورِ"، حرف الجر المستخدم هو:',
        options: ['الباء', 'الكاف', 'التاء', 'ربَّ'],
        correctIndex: 1,
        explanation: 'تم استعمال الكاف للتشبيه: العلمُ كالنورِ.'
      },
      {
        id: 'jar-q4',
        question: 'أيُّ حرفٍ من حروف الجر يفيد معنى القَسَم؟',
        options: ['اللام', 'التاء', 'مذ', 'عن'],
        correctIndex: 1,
        explanation: 'التاء تأتي للقَسَم كما في: تاللهِ لا يذهبُ الخيرُ.'
      },
      {
        id: 'jar-q5',
        question: 'المعنى المناسب لحرف الجر "من" في مثال: خرج محمد من الدار هو:',
        options: ['الانتهاء', 'الابتداء', 'السببية', 'التقليل'],
        correctIndex: 1,
        explanation: '"من" هنا تفيد ابتداء السير من مكان الخروج.'
      }
    ]
  },
  'ism-majrur': {
  ...
  interrogatives: {
    ...
    images: ['lessons/أسلوب%20الاستفهام/أدوا%20ت%20الاستفهام.jpg'],
    contentHtml: `
      <p>
        أسلوب الاستفهام يُستخدم لطلب الفهم أو الاستعلام عن عاقل أو غير عاقل، زمان أو مكان أو عدد أو حال.
      </p>
