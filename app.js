...
const LESSONS = {
    ...
    contentHtml: `
      ...
      <p>
        يمكن أن يدل الاسم على:
        إنسان (محمد، عائشة)،
        أو حيوان (أسد، قطة)،
        أو نبات (عنب، تفاح)،
        أو جماد (ساعة، قلم، حائط).
      </p>

      <h4>ثانيًا: الفعل</h4>
      <p>
        هو كلمة تدل على معنى في نفسها وتقترن بزمن معيّن
        (ماضٍ أو مضارع أو أمر).
      </p>
      <ul>
        <li><strong>الفعل الماضي:</strong> يدل على حدث وقع في الزمن الماضي، مثل: <em>نصرَ، فهمَ، جلسَ</em>.</li>
        <li><strong>الفعل المضارع:</strong> يدل على حدث يحدث الآن أو يستمر، مثل: <em>ينصرُ، يجلسُ، يجتهدُ</em>.</li>
        <li><strong>فعل الأمر:</strong> يدل على طلب حدوث الفعل في المستقبل، مثل: <em>انصرْ، اجلسْ، اجتهدْ</em>.</li>
      </ul>

      <h4>ثالثًا: الحرف</h4>
      <p>
        هو كلمة لا يظهر معناها كاملًا وحدها، بل يتّضح بالاقتران مع غيرها،
